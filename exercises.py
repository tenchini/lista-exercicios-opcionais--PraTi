...
(Dicas: desconto de 12%, salário líquido é a diferença entre salário bruto e a redução do INSS).""",
    ...
    """23. Criar e imprimir a matriz identidade M[[1..7,1..7]] em que todos os elementos da diagonal principal são iguais a 1 e os demais são nulos.""",
...
5- mostre o vetor.""",
    ...
    """42. Crie um objeto chamado dados que contêm várias propriedades, incluindo números, strings e arrays. Escreva uma função que retorne um novo objeto apenas com as propriedades que são arrays.""",
